            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="-mr-2 flex md:hidden">
                        <!-- Mobile menu button -->
                        <button @click="toggleNav()" type="button" class="inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 focus:outline-none focus:shadow-none" aria-controls="mobile-menu" aria-expanded="false">
