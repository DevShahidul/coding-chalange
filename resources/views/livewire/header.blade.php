...
<header class="header sticky z-50 top-0 shadow-md shadow-slate-100 dark:shadow-gray-700">
    <nav class="bg-white dark:bg-gray-800" x-data="{ dropdownExpanded: false, navExpanded: false, toggleNav() {this.navExpanded = !this.navExpanded} }">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    <div class="hidden lg:ml-8 lg:flex">
                        <a href="#" class="flex items-center text-gray-700 hover:text-gray-800 dark:text-gray-400">
                    ...
                    <div class="relative ml-4 lg:ml-6">
                        <button @click="dropdownExpanded = !dropdownExpanded" type="button" class="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" :aria-expanded="dropdownExpanded" aria-haspopup="true">
                    ...
                    <div class="-mr-2 flex md:hidden">
                        <!-- Mobile menu button -->
                        <button @click="toggleNav()" type="button" class="inline-flex items-center justify-center rounded-md ml-2 p-2 text-gray-400 focus:outline-none focus:shadow-none" aria-controls="mobile-menu" aria-expanded="false">
                            <span class="sr-only">Open main menu</span>
                            <svg :class="{ 'block' : !navExpanded , 'hidden' : navExpanded}" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                            </svg>
                            <svg x-show="navExpanded" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
        ...
        <div x-show="navExpanded" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-y-90" x-transition:enter-end="opacity-100 scale-y-100" class="origin-top md:hidden" id="mobile-menu">
